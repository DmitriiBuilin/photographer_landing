Vue.component('bigphoto', {
    ...
    // },
    template: `
    <div id="pop-up-1" class="portfolio-mosaic-item">    
        <img class="portfolio-mosaic-img" src="img/bigphoto/portfolio-ph-01.jpg" alt="portfolio-img">
        <a class="portfolio-mosaic-img-close-button" href="#portfolio-top">
